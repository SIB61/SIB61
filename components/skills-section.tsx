    ...
    <section className="py-20 px-4 relative">
      <div className="max-w-6xl mx-auto">
        <RevealAnimation direction="up">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              A comprehensive overview of my technical expertise with a focus on design patterns and clean architecture.
            </p>
          </div>
        </RevealAnimation>
                      ...
                      <div className="flex items-center space-x-3">
                        <div
                          className={`p-2 rounded-lg transition-all duration-300 ${
                            isActive ? "bg-white/20 backdrop-blur-sm" : "bg-gray-700 group-hover:bg-gray-600"
                          }`}
                        >
                          <IconComponent
                        ...
                        <div>
                          ...
                          <p className="text-sm opacity-75">{category.skills.length} technologies</p>
                        </div>
                      </div>
                    </button>
                  )
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center space-x-4 mb-8">
                    <div className={`p-3 rounded-xl bg-gradient-to-r ${activeSkillCategory.gradient} shadow-lg`}>
                      <activeSkillCategory.icon className="w-6 h-6 text-white" />
                    </div>
                    <div>
                      <h3 className="text-2xl font-bold text-white">{activeSkillCategory.title}</h3>
                      <p className="text-gray-400">{activeSkillCategory.skills.length} technologies in this category</p>
                    </div>
                  </div>
                      ...
                      >
                        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-4 hover:border-gray-600 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-lg">
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            >
                              <span className="text-white font-bold text-lg">{getTechIcon(skill)}</span>
                            </div>
                            <div className="flex-1 min-w-0">
                              <h4 className="font-semibold text-white text-sm truncate">{skill}</h4>
                              <div className="flex items-center space-x-1 mt-1">
                                {[...Array(5)].map((_, i) => (
                                  <Star
                                    key={i}
                                    className={`w-3 h-3 ${
                                      i < 4 ? activeSkillCategory.color : "text-gray-600"
                                    } fill-current`}
                                  />
                                ))}
                              </div>
                          ...
                          {[...Array(5)].map((_, i) => (
                            <div
                              ...
                              className={`w-2 h-2 rounded-full ${
                                i < 4 ? `bg-gradient-to-r ${activeSkillCategory.gradient}` : "bg-gray-600"
                              }`}
                            ></div>
                          ))}
                        </div>
        ...
        <div className="md:hidden space-y-8">
          ...
          {/* Skills Display - Mobile */}
          <RevealAnimation direction="right" delay={400}>
            <div>
              <GradientBackground
                variant="card"
                className="p-8 rounded-xl border border-gray-700 relative overflow-hidden"
              >
                {/* Background Pattern */}
                <div className="absolute inset-0 opacity-5">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600"></div>
        ...
        <RevealAnimation direction="up" delay={600}>
          <div className="mt-16">
            <div className="grid md:grid-cols-3 gap-6">
              <GradientBackground variant="card" className="p-6 rounded-lg border border-gray-700 text-center">
                <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <Settings className="w-6 h-6 text-white" />
                </div>
                <h4 className="text-xl font-bold text-white mb-2">Backend Expert</h4>
                <p className="text-gray-400 text-sm">
                  Specialized in Node.js ecosystem with {skillsData.backend.length}+ backend technologies
                </p>
              </GradientBackground>
              ...
              <GradientBackground variant="card" className="p-6 rounded-lg border border-gray-700 text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Modern React development with {skillsData.frontend.length}+ frontend technologies
                </p>
              </GradientBackground>
              ...
              <GradientBackground variant="card" className="p-6 rounded-lg border border-gray-700 text-center">
                ...
                <h4 className="text-xl font-bold text-white mb-2">Cloud & DevOps</h4>
                <p className="text-gray-400 text-sm">
                  Modern deployment with {skillsData.cloud.length}+ cloud platforms
                </p>
              </GradientBackground>
            </div>
          </div>
