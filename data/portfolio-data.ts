...
export function getPersonalInfo(): PersonalInfo {
  return {
    ...
    subtitle: "Software Engineer with 2+ years of experience in NodeJs and NextJs ecosystem",
    description:
...
export function getSocialLinks(): SocialLink[] {
  return [
    { name: "github", icon: "github", link: "https://github.com/sib61", label: "GitHub" },
    { name: "email", icon: "mail", link: "mailto:sib.sustswe@gmail.com", label: "Email" },
    { name: "instagram", icon: "instagram", link: "https://www.instagram.com/sabit_islam_bhuiya/", label: "Instagram" },
    { name: "twitter", icon: "twitter", link: "https://www.linkedin.com/in/sib61/", label: "Linkedin" },
  ]
}
  ...
  return [
    {
      ...
      companyImage: "https://media.licdn.com/dms/image/v2/D560BAQHjoQGwlOhYQg/company-logo_200_200/company-logo_200_200/0/1709195320516/jb_connect_limited_logo?e=1755129600&v=beta&t=DZF0yjNFapO1onBNRAT2CYFP67_Ix3uz0eWa0J557PM",
      ...
      technologies: ["Node.js", "Next.js", "AWS", "PostgreSQL", "Prisma", "TypeScript"],
    },
    {
      id: "shellbeehaken-engineer",
      companyName: "Shellbeehaken Ltd.",
      companyImage: "https://media.licdn.com/dms/image/v2/C4D0BAQG8wvjCFbINNg/company-logo_200_200/company-logo_200_200/0/1656188465781/shellbeehaken_logo?e=1755129600&v=beta&t=Wexxf-bKMWBEveB_AxS92O72tGjUZlpHPHc1GIdee1o",
    ...
    },
    {
      ...
      technologies: ["Next.js", "Node.js", "MongoDB", "React", "JavaScript","Redis"],
    },
    {
      ...
      technologies: ["HTML", "CSS", "JavaScript", "React", "MongoDB", "Express.js", "Next.js", "Git"],
    },
    {
      id: "geeky-solutions",
      companyName: "Geeky Solutions",
      companyImage: "https://geeky.solutions/wp-content/uploads/2020/09/favicon.ico",
      ...
      technologies: ["TypeScript", "Angular", "MongoDB", ".NET Core", "RabbitMQ", "SignalR"],
    },
  ]
}
  ...
  return [
    {
      ...
      technologies: ["Next.js", "MongoDB", "Socket.IO", "React", "Tailwind CSS"],
      featured: true,
    },
    {
      ...
      githubLink: "https://github.com/SIB61/Tweeter-clone-Learnathon-final-project-",
      description:
      ...
      technologies: ["Angular", "SignalR", ".NET Core", "MongoDB", "RabbitMQ", "Redis"],
      featured: true,
    },
    {
      id: "express-folder-router",
      title: "Express Folder Router",
      cover: "https://th.bing.com/th/id/R.64bd21adf0efc47f19a6643516a23426?rik=XbxZLBVOeMaQkw&riu=http%3a%2f%2fanpsthemes.com%2fwp-content%2fuploads%2f2016%2f03%2fnpm-1.jpg&ehk=vsbtr9uLTdV5gUm%2fBaYlC%2fRvVG%2fgKX3j2XlZbJqWt28%3d&risl=&pid=ImgRaw&r=0",
    ...
    },
    {
      ...
      technologies: ["Java", "Android", "Firestore", "Firebase", "Material Design"],
      featured: true,
    },
    {
      id: "roll-the-dice",
    ...
    },
    {
      ...
      description: "A real time end to end encrypted messaging app using java and android with firebase as a backend service.",
...
export function getSkills() {
  return {
    frontend: ["React.js", "Next.js", "TypeScript", "Angular", "Tailwind CSS", "HTML5", "CSS3"],
    backend: ["Node.js", "Express.js", ".NET Core", "Prisma", "REST APIs", "GraphQL", "Microservices"],
    database: ["MongoDB", "PostgreSQL", "Redis", "Firestore", "MySQL", "SQLite"],
    cloud: ["AWS", "Vercel", "Firebase", "Docker", "Kubernetes", "Netlify"],
    tools: ["Git", "RabbitMQ", "SignalR", "Socket.IO", "Webpack", "Vite", "Jest"],
  }
}
